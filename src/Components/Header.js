...
function Header() {
  ...
  const { linkdein, github, leetcode } = socialMediaUrl;
  const toggleClass = () => {
    setIsOpen(!isOpen);
  };
        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          <li>
            <a href={leetcode} target="_blank" rel="noreferrer noopener">
              <img className="w-8 h-8" src="https://repository-images.githubusercontent.com/660115526/cbbcd367-535a-4e9d-927b-9eacd8d652e8" alt="leetcode"></img>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="/Resume.pdf" target="_blank" rel="noopener noreferrer">
              <img className="w-8 h-8" src="https://cdn-icons-png.flaticon.com/512/8101/8101319.png" alt="resume"></img>
            </a>
          </li>
        </ul>
      </nav>
